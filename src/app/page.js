...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("http://13.202.8.46:5000/auth/login", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        const userDetailsResponse = await fetch("http://13.202.8.46:5000/user/me", {
          method: "GET",
          headers: {
...
//     // Redirect to dashboard regardless of login success for demonstration
//     router.push("/dashboard");
